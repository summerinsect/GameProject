...
public class RuleManager : MonoBehaviour {
    ...
    private void Start() {
        titles[0] = "概述";
        details[0] = "本游戏是一款rougelike自走棋游戏。\r\n在游戏中，玩家需要深入丛林，招募动物战士们，闯过重重关卡，击败最终敌人。";
        titles[1] = "地图";
        ...
        titles[5] = "商店";
        details[5] = "在商店中，玩家可以消耗金币招募动物战士（下称角色）。\r\n点击背包或商店中的角色，可以在右侧的面板区查看属性。\r\n如果角色距离最近的敌人不超过攻击距离，则角色会对范围内的随机敌人进行攻击，否则角色会移动到相邻的空格。\r\n角色每次攻击的作用范围，是以被攻击的敌人为中心，边长等于攻击范围的正六边形。\r\n速度决定了角色两次行动的间隔，速度值越大，间隔越小。";
        titles[6] = "事件";
