...
public class StageLoader : MonoBehaviour
{
	...
	public void StageInit()
	{
		...
		BattleManager.instance.AddMember(1, CharacterCreater.instance.CreateCharacter("melee", 1, new Vector3Int(2, -3, 1)));
		BattleManager.instance.AddMember(0, CharacterCreater.instance.CreateCharacter("melee", 0, new Vector3Int(-2, -3, 5)));
		BattleManager.instance.AddMember(0, CharacterCreater.instance.CreateCharacter("melee", 0, new Vector3Int(-2, -1, 3)));
