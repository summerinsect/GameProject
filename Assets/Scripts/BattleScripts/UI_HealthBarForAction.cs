...
public class UI_HealthBarForAction : MonoBehaviour {
    ...
    public void UpdateHealthUI(Character _character) {
        ...
        float healthPercent = 1.0f * character.currentHealth / character.currentMaxHealth;
        float shieldPercent = 1.0f * character.shield / character.currentMaxHealth;
        ...
        healthText.GetComponent<TextMeshProUGUI>().text = character.currentHealth.ToString() + "/" + character.currentMaxHealth.ToString();
    }
}
